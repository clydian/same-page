...
export const ATTACHMENT_LIMITS = { audio: 50 * 1024 * 1024, pdf: 20 * 1024 * 1024, markdown: 1024 * 1024 } as const;
export const MAX_SCORE_ATTACHMENTS = 100;
export const ATTACHMENT_ACCEPT = ".mp3,.m4a,.aac,.wav,.flac,.ogg,.opus,.pdf,.md";
...
export function attachmentAccept(kind: "audio" | "pdf" | "markdown") {
...
export const attachmentSchema = z.object({
  id: z.string(), scoreId: z.string(), name: z.string(), kind: z.enum(["link", "audio", "pdf", "markdown"]),
