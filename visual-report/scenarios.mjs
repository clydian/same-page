...
export const visualReportScenarios = [
  ...
  },
  {
    ...
    actions: [
      { type: "clickCenter", selector: ".page-reader__viewport" },
      { type: "clickRole", role: "button", name: "编辑" },
      { type: "clickRole", role: "button", name: "当前编辑层：我的笔记，编辑图层" },
  ...
  },
  {
    ...
    identity: "admin",
    route: "/choirs/visual-choir/scores/visual-score",
    ready: { type: "selector", selector: ".reader-edit-layer-trigger[aria-label=\"当前编辑层：Ensemble，编辑图层\"]" },
    actions: [
      { type: "clickCenter", selector: ".page-reader__viewport" },
      { type: "clickRole", role: "button", name: "编辑" },
      { type: "clickRole", role: "button", name: "当前编辑层：我的笔记，编辑图层" },
  ...
  },
  {
    ...
    title: "阅读器 · 谱面原位输入文字",
    description: "轻遮罩区分输入状态，文字保留谱面位置，顶部提示完成方式。",
    device: "landscape",
    identity: "member",
    route: "/choirs/visual-choir/scores/visual-score",
  ...
  {
    id: "reader-text-compose-phone",
    title: "阅读器 · 手机文字输入",
    description: "手机宽度下顶部完成提示与文字样式工具保持清晰；不模拟系统键盘。",
    device: "narrow",
    identity: "member",
    route: "/choirs/visual-choir/scores/visual-score",
    ready: { type: "selector", selector: ".annotation-text-composer[data-active]" },
